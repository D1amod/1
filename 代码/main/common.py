...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/pythone1511/examusers/login" ,
            "/pythone1511/examusers/register",
            '/pythone1511/defaultuser/login',
            '/pythone1511/users/login',
        ...
        post_list = [
            '/pythone1511/defaultuser/register',
            '/pythone1511/defaultuser/login',
            '/pythone1511/users/register',
            '/pythone1511/users/login',
            "/pythone1511/examusers/login" ,
            "/pythone1511/examusers/register"
        ]  # 免认证list
