...
# 注册接口
@main_bp.route("/pythone1511/news/register", methods=['POST'])
def pythone1511_news_register():
...
# 登录接口
@main_bp.route("/pythone1511/news/login", methods=['GET','POST'])
def pythone1511_news_login():
...
# 登出接口
@main_bp.route("/pythone1511/news/logout", methods=['POST'])
def pythone1511_news_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythone1511/news/resetPass", methods=['POST'])
def pythone1511_news_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/pythone1511/news/session", methods=['GET'])
def pythone1511_news_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/pythone1511/news/page", methods=['GET'])
def pythone1511_news_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/pythone1511/news/autoSort", methods=['GET'])
def pythone1511_news_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/pythone1511/news/list", methods=['GET'])
def pythone1511_news_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/pythone1511/news/save", methods=['POST'])
def pythone1511_news_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/pythone1511/news/add", methods=['POST'])
def pythone1511_news_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/pythone1511/news/thumbsup/<id_>", methods=['GET'])
def pythone1511_news_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/pythone1511/news/info/<id_>", methods=['GET'])
def pythone1511_news_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/pythone1511/news/detail/<id_>", methods=['GET'])
def pythone1511_news_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/pythone1511/news/update", methods=['POST'])
def pythone1511_news_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/pythone1511/news/delete", methods=['POST'])
def pythone1511_news_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/pythone1511/news/vote/<int:id_>", methods=['POST'])
def pythone1511_news_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/pythone1511/news/group/<columnName>", methods=['GET'])
def pythone1511_news_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/pythone1511/news/value/<xColumnName>/<yColumnName>", methods=['GET'])
def pythone1511_news_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/pythone1511/news/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def pythone1511_news_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 推荐算法接口
@main_bp.route("/pythone1511/news/autoSort2", methods=['GET'])
def pythone1511_news_autoSort2():
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/pythone1511/news/remind/<columnName>/<type>", methods=['GET'])  #
def pythone1511_news_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
