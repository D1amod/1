...
@main_bp.route("/pythone1511/cal/<tableName>/<columnName>", methods=['GET'])
def pythone1511_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/pythone1511/file/download", methods=['GET'])
def pythone1511_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythone1511/file/upload", methods=['POST'])
def pythone1511_file_upload():
    '''
    '''
...
@main_bp.route("/pythone1511/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def pythone1511_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythone1511/follow/<tableName>/<columnName>", methods=['GET'])
def pythone1511_follow(tableName, columnName):
    '''
...
@main_bp.route("/pythone1511/location", methods=['GET'])
def pythone1511_location():
    '''
...
@main_bp.route("/pythone1511/matchFace", methods=['GET'])
def pythone1511_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythone1511/option/<tableName>/<columnName>", methods=['GET'])
def pythone1511_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythone1511/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def pythone1511_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythone1511/sh/<tableName>", methods=['POST'])
def pythone1511_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("pythone1511_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/pythone1511/upload/<fileName>", methods=['GET'])
def pythone1511_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythone1511/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/pythone1511/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
...
# 爬取数据
@main_bp.route("/pythone1511/spider/<tableName>", methods=['GET'])
def schema_spider(tableName):
    msg = {"code": normal_code, "msg": "success", "data": []}

    # Linux
    # cmd = "cd /yykj/python/9999/spider85tlv && scrapy crawl "+tableName+"Spider -a databaseName=pythone1511"
    # Windows
    cmd = "cd D:\\毕设\\spider && D:\\Env\\Python\\Python37\\Scripts\\scrapy.exe crawl " + tableName + "Spider"
    os.system(cmd)
